...
from serializers.tea import TeaSchema, TeaCreate, TeaUpdate
...
def update_tea(tea_id: int, tea: TeaUpdate, db: Session = Depends(get_db), current_user: UserModel = Depends(get_current_user)):
